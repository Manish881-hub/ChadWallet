      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 sm:gap-6">
        ...
        <div className="flex flex-col mb-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {profile.twitter && (
              <a href={`https://twitter.com/${profile.twitter}`} target="_blank" rel="noreferrer" className="text-[#888] hover:text-[#1DA1F2] transition-colors">
            ...
            {profile.website && (
              <a href={profile.website} target="_blank" rel="noreferrer" className="text-[#888] hover:text-white transition-colors">
      ...
      <div className="flex flex-col sm:items-end gap-3 mb-2 w-full sm:w-auto">
        ...
        <div className="flex items-center gap-2 mt-2 w-full sm:w-auto">
          ...
          <button
            ...
            className="w-9 h-9 flex items-center justify-center border border-[#1F1F1F] bg-[#111111] hover:bg-white/5 rounded-lg transition-colors shrink-0"
