  ...
  return (
    <div className="relative shrink-0" ref={menuRef}>
      <button 
        ...
        className="w-7 h-7 rounded-full bg-[#111111] border border-[#1F1F1F] flex items-center justify-center overflow-hidden hover:ring-2 hover:ring-[#4D62FF]/50 transition-all focus:outline-none"
      >
        {avatarContent}
      </button>
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-1 flex flex-col">
              <Link href="/profile/me" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm text-[#E0E0E0] hover:text-white">
              ...
              <button onClick={() => {
                ...
                setIsOpen(false);
              }} className="flex items-center gap-3 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm text-[#E0E0E0] hover:text-white w-full text-left">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                {user?.wallet?.address ? `Copy wallet` : 'Wallet'}
              </button>
              <div className="h-px bg-[#1F1F1F] my-1 mx-2" />
              <button onClick={() => { setIsOpen(false); setDepositOpen(true); }} className="flex items-center gap-3 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm text-[#E0E0E0] hover:text-white w-full text-left">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 5v14M5 12l7 7 7-7"/></svg>
                Deposit
              </button>
              <button onClick={() => { setIsOpen(false); setWithdrawOpen(true); }} className="flex items-center gap-3 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm text-[#E0E0E0] hover:text-white w-full text-left">
              ...
              }} className="flex items-center gap-3 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm text-[#E0E0E0] hover:text-white w-full text-left justify-between">
              ...
              <button onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-3 py-2 hover:bg-white/5 rounded-lg transition-colors text-sm text-[#E0E0E0] hover:text-white w-full text-left">
